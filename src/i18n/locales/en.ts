...
const en = {
  // ── App / Lock Screen ────────────────────────────────────────────────────
  'app.loading': 'Unlocking Altron…',
  'app.loadingSkills': 'Loading skills…',
  'app.locked.title': 'Altron is locked',
  ...
  'alert.micPermission.message': 'Altron needs access to the microphone.',
  ...
  'home.empty.title': 'Altron AI Assistant',
  ...
  'home.thinking': 'Altron is thinking…',
  ...
  'settings.about.debugFileHint': 'Log file: Documents/altron.txt',
  ...
  // Wake Word
  'settings.wakeWord.label': "Activate 'Hey Altron'",
  ...
  // SOUL
  'settings.soul.description': 'Define Altron\'s personality and tone.',
  ...
  // Lists Screen
  'lists.title': 'Lists',
  'lists.empty': 'No lists found.\nCreate a list by telling Altron e.g. "Add milk to the shopping list"',
  ...
  'schedules.empty': 'No scheduled tasks found.\nCreate one by telling Altron e.g. "Remind me tomorrow at 9 am…"',
  ...
  'notifListeners.empty': 'No app rules found.\nCreate one by telling Altron e.g. "Read me WhatsApp messages aloud"',
  ...
  'settings.services.picovoice.instructions': 'Sign up at console.picovoice.ai and copy your Access Key from the dashboard. Required for the "Hey Altron" wake-word feature.',
  ...
  'journal.empty': 'No journal entries found.\nCreate an entry by telling Altron e.g. "Make an entry in the journal that I went jogging today"',
