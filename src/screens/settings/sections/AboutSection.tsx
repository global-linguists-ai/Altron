  ...
  return (
    <>
      <View
        ...
        <Text className="text-label-primary text-base font-semibold">Altron</Text>
        <Text className="text-label-secondary text-[13px] mt-0.5">Version 0.1.0 (Phase 1 MVP)</Text>
        <Text className="text-label-tertiary text-xs mt-1.5 font-medium text-indigo-400">
          Developer: Abbas Khan
        </Text>
      </View>
